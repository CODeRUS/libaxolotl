...
void protobuf_AssignDesc_LocalStorageProtocol_2eproto() {
  protobuf_AddDesc_LocalStorageProtocol_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_LocalStorageProtocol_2eproto);
}
...
void protobuf_AddDesc_LocalStorageProtocol_2eproto() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "LocalStorageProtocol.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_LocalStorageProtocol_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_LocalStorageProtocol_2eproto {
  StaticDescriptorInitializer_LocalStorageProtocol_2eproto() {
    protobuf_AddDesc_LocalStorageProtocol_2eproto();
  }
} static_descriptor_initializer_LocalStorageProtocol_2eproto_;
...
const SessionStructure_Chain_ChainKey& SessionStructure_Chain_ChainKey::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_LocalStorageProtocol_2eproto();
